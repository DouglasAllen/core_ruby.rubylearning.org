...
=begin
This challenge is a 'light challenge' hopefully for all involved and participating in the course so far.

SPLIT A STRING ALIGNMENT CHALLENGE

by: Victor Goff – Sunday, 2 November 2008, 04:03 PM
There is a way to not have to have your line_num variable hanging around outside of the block. Did you find it?

@Everyone… Challenge?

Can you do something so that if it isn’t simply 3 lines, or 1000 lines, your output ends up something like this? (leading spaces or 0’s acceptable)
...
Anyone else know of a challenge that they think should be able to be solved with the knowledge gained so far? You can also update the first week challenges with things learned from this week if you find it makes it simpler, or more elegant! Blocks anyone?
=end
